...
export default function StatsCard({
  ...
  return (
    <div className="inline-flex relative w-max min-w-full items-center rounded group cursor-pointer hover:bg-primary/10 h-[60px] text-sm gap-2 transition-colors">
